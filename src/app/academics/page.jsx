  ...
  const renderPopup = () => (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-8 rounded-lg shadow-lg w-1/3">
        ...
        <button
          className="mt-4 ml-2 bg-red-500 text-white py-2 px-4 rounded hover:bg-red-600 transition-colors"
          onClick={closePopup}
        >
          Close
        </button>
                ...
                <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden">
                  ...
                  <div className="p-4">
                    ...
                    <button
                      ...
                      onClick={() => openPopup(`Connect with ${mentor.name}`)}
                    >
                      Ask for advice
                    </button>
                  </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              {faculties.map((faculty, index) => (
                <div key={index} className="bg-white rounded-lg shadow-md p-4 flex flex-col items-center">
                  ...
                  <p className="text-sm text-gray-600 text-center"><span className="font-bold" >Past_collaboration :- </span>{faculty.past_collaboration}</p>
                  <button
                    className="mt-2 w-full text-white py-2 rounded bg-[#04141e] hover:bg-[#042438] transition-colors"
                    onClick={() => openPopup(`Contact ${faculty.name}`)}
                  >
                    Contact
                  </button>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              {projects.map((project, index) => (
                <div key={index} className="bg-white rounded-lg shadow-md p-4 flex flex-col items-center">
                  ...
                  <div className="mt-2 space-x-2">
                    <button
                      className="bg-[#04141e] hover:bg-[#042438] text-white py-2 px-4 rounded  transition-colors"
                      onClick={() => openPopup(`Join ${project.title}`)}
                    >
                      Join Project
                    </button>
                    <button
                      className="bg-[#07633c] hover:bg-[#128958] text-white py-2 px-4 rounded  transition-colors"
                      onClick={() => openPopup(`Submit Proposal for ${project.title}`)}
                    >
                      Submit Proposal
                    </button>
                  </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              {fundingSources.map((funding, index) => (
                <div key={index} className="bg-white rounded-lg shadow-md p-4 flex flex-col items-center">
                  ...
                  <button
                    className="mt-2 w-full  text-white py-2 rounded bg-[#04141e] hover:bg-[#042438] transition-colors"
                    onClick={() => openPopup(`Apply for ${funding.source_name}`)}
                  >
                    Apply for Funding
                  </button>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              {researchCollaborations.map((collab, index) => (
                <div key={index} className="bg-white rounded-lg shadow-md p-4 flex flex-col items-center">
                  ...
                  <button
                    className="mt-2 w-full  text-white py-2 rounded bg-[#04141e] hover:bg-[#042438] transition-colors"
                    onClick={() => openPopup(`Join Research in ${collab.field}`)}
                  >
                    Join Research
                  </button>
                </div>
