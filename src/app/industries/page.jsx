...
//                 <div key={index} className="bg-white rounded-lg shadow-md p-4 flex flex-col items-center">
//                   <img
//                 src={Industry_Level_Projects.img}
//                 alt=""
//                 className="w-[100px] h-[100px] rounded-full"
//               />
//                   <h3 className="text-lg font-semibold "><span className="font-bold" >Title :- </span>{Industry_Level_Projects.title}</h3>
//                   <p className="text-sm text-gray-600"><span className="font-bold">Description :- </span>{Industry_Level_Projects.description}</p>
//                   <p className="text-sm text-gray-600"><span className="font-bold">Participating Companies :- </span>{Industry_Level_Projects.participating_companies}</p>
//                   <p className="text-sm text-gray-600"><span className="font-bold">Student Teams :- </span>{Industry_Level_Projects.student_teams}</p>
//                   <p className="text-sm text-gray-600"><span className="font-bold">OnGoing Status :- </span>{Industry_Level_Projects.ongoing_status}</p>
//                   <p className="text-sm text-gray-600" ><span className="font-bold">Result :- </span>{Industry_Level_Projects.results}</p>
//                   <p className="text-sm text-gray-600">
//                     Company: {Industry_Level_Projects.company}
//                   </p>
...
//       >
//         <h2 className="text-4xl font-bold mb-6">Industry</h2>
